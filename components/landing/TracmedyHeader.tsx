      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a className="hidden sm:inline-flex rounded-full bg-primary px-6 py-2.5 text-sm font-bold text-primary-foreground shadow-lg shadow-primary/20 hover:opacity-90 transition-all" href="#waitlist">
              Join Waitlist
            </a>
        ...
        {mobileOpen && (
          <>
            ...
            >
              ...
              <a className="mt-4 rounded-full bg-primary px-6 py-3 text-sm font-bold text-primary-foreground text-center" href="#waitlist" onClick={() => setMobileOpen(false)}>Join Waitlist</a>
            </motion.nav>
          </>
        )}
      </AnimatePresence>
