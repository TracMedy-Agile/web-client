  ...
  const sidebar = (
    <aside
      className={cn(
        ...
        isCollapsed ? "md:w-16" : "md:w-16 lg:w-60",
        "w-60",
      ...
      <div className={cn("flex items-center py-6", isCollapsed ? "justify-center px-3" : "justify-center px-3 lg:justify-between lg:px-5")}>
        {isCollapsed ? (
          <button
            ...
            className="rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80"
          >
            <Image src="/favicon.svg" alt="" width={40} height={40} className="shrink-0" />
          </button>
        ) : (
          <>
            <div className="flex min-w-0 items-center gap-2">
              <Image src="/favicon.svg" alt="Tracmedy" width={40} height={40} className="shrink-0" />
              <span className="hidden truncate text-lg font-bold tracking-wide lg:inline">TRACMEDY</span>
            </div>
            <button
              type="button"
              aria-label="Collapse sidebar"
              onClick={() => setIsCollapsed(true)}
              className="hidden text-white/70 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80 lg:block"
            >
