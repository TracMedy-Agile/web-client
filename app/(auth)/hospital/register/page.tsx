  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
     const result = await apiRegister({ hospitalId, name, email, password })
      ...
      router.push(`/hospital/verify-email?userId=${encodeURIComponent(userId)}&email=${encodeURIComponent(email)}`)
    } finally {
      setIsLoading(false)
    }
  }
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary">
                    <Image src={hospital_id} alt="Hospital ID Icon" width={16} height={16} />
                  </span>
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary">
                    <Image src={hospital} alt="Hospital Icon" width={16} height={16} />
            ...
            <p className="text-center mt-6 text-gray-600 text-sm">
              ...
              <Link href="/hospital/login" className="text-primary font-bold hover:underline">
                Login
              </Link>
            </p>
